...

{
  ...
  supported_countries: "Global",
  fiat_deposit: false,
  volume_24h: "High ($743M – $4.9B)",
  fees: "0.02% maker / 0.05% taker",
  reputation: "High (DeFi, new platform, rising adoption)",
  cryptocurrencies: "90+",
  blockchains: ["Ethereum", "StarkEx L2"],
  features: [
    "Perpetual futures",
    "Orderbook DEX",
    "Leverage up to 50x",
...
},
  {
    ...
    logo: "https://cdn.brandfetch.io/idGSMNVeGY/w/200/h/200/theme/dark/icon.png?c=1dxbfHSJFAPEGdCLU4o5B",
    kyc_tier: "None",
    supported_countries: "Global",
    fiat_deposit: false,
    volume_24h: "High - 25% DEX market share",
    fees: "Low",
    reputation: "High - Fastest growing DEX 2024",
    cryptocurrencies: "Multiple",
    blockchains: ["Hyperliquid Chain"],
    features: ["Perpetual Contracts", "40x Leverage", "On-chain Orderbook", "No Wallet Approvals"]
},
{
    name: "1inch",
    type: "DEX",
    ...
    logo: "https://pbs.twimg.com/profile_images/1985306310821498880/NjWKByyx_400x400.jpg",
    kyc_tier: "None",
    supported_countries: "Global",
    fiat_deposit: false,
    volume_24h: "",
    fees: "Variable (aggregator)",
    reputation: "High",
    cryptocurrencies: "Multiple",
    blockchains: ["Ethereum", "BSC", "Polygon", "Multiple"],
    features: ["DEX Aggregator", "Best Rates", "Smart Order Routing", "Low Slippage"]
},
  {
  name: "DeGate",
  type: "DEX",
  url: "https://app.degate.com/?utm_source=donotkyc",
...
},
{
    ...
    logo: "https://pbs.twimg.com/profile_images/1439339323971805187/T-oBcFh6_400x400.jpg",
    kyc_tier: "No KYC required, but may cooperate with authorities and freeze funds if suspicious activity detected",
    supported_countries: "Global",
    fiat_deposit: false,
    volume_24h: "Not publicly disclosed",
    fees: "Approx. 2.2% flat fee, with possibility to earn fee rebate by providing liquidity",
    reputation: "Mixed reviews; praised for privacy and instant swaps, some concerns on support and liquidity",
    cryptocurrencies: "Supports privacy coins such as Monero (XMR), Dash, Zcash, Particl, PIVX, Firo, and more",
    features: [
        "No registration required",
        "Supports Tor (Onion) network access",
        "Non-custodial swaps with user's own wallets",
  ...
  logo: "https://imgs.search.brave.com/GrZ_fe2KtJ5v2oVrNMa9G-kKFBaOWYrPO9H5pNA_xC0/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9jb25z/dW1lcnNpdGVpbWFn/ZXMudHJ1c3RwaWxv/dC5uZXQvYnVzaW5l/c3MtdW5pdHMvNjQz/ZTA2YWE2MmViOWM2/NGFhYWUyMDQ4LTE5/OHgxNDktMXguanBn",
  kyc_tier: "Depends on partners (no account on Trocador; some partners may request KYC on risk flags)",
  supported_countries: "Global",
  fiat_deposit: true,
  volume_24h: "Not disclosed",
  fees: "Included in partner rate; network + partner fees in quote",
  reputation: "Privacy-focused aggregator with partner ratings and limited guarantee",
  cryptocurrencies: "60+",
  features: [
    "Exchange aggregator (multiple instant exchanges)",
    "No account required",
    "Fixed and floating rates",
    "Payment mode (exact-output)",
    "Fiat gateway aggregator",
    "Tor and JS-free options",
    "Shows partner KYC/log policies",
  ...
  fiat_deposit: false,
  volume_24h: "Not disclosed",
  fees: "0.5% fixed fee + network fees",
